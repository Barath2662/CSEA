...
img=PIL.Image.open(r"C:\Users\preet\Downloads\DROWSINESS DETECTION (2)\DROWSINESS DETECTION\login.jpeg")
photoimg1=ImageTk.PhotoImage(img)
Label(w,image=photoimg1,bg="white").place(x=50,y=50)
Frame(w,width=350,height=350,bg="white",bd="5").place(x=480,y=70)
Label(w,text="Sign in",bg="white",fg="blue",font=("Microsoft YaHei UI Light",23,"bold")).place(x=600,y=80)
a=Entry(w,width=27,bg="white",fg="black",border=0,font=("Microsoft YaHei UI Light",12))
a.place(x=520,y=175)
a.insert(0,"Username")
a.bind("<FocusIn>",enter)
a.bind("<FocusOut>",leave)
Frame(w,width=250,height=2,bg="black").place(x=515,y=200)
b=Entry(w,width=27,bg="white",fg="black",border=0,font=("Microsoft YaHei UI Light",12),show="*")
b.place(x=520,y=250)
b.insert(0,"Password")
b.bind("<FocusIn>",enter1)
b.bind("<FocusOut>",leave1)
Frame(w,width=250,height=2,bg="black").place(x=515,y=275)
Button(w,text="Sign in",width=30,height=2,bg="blue",fg="white",command=chec).place(x=525,y=320)
    ...
    for subject in subjects:
        ...
        if ear < 0.25:
            ...
            if alert_count >= 10 and not pygame.mixer.get_busy():
                ...
                cv2.putText(frame, "         ALERT!", (frame.shape[1] - 550, 30),
                            cv2.FONT_HERSHEY_SIMPLEX, 1.2, (0, 0, 255), 4)
